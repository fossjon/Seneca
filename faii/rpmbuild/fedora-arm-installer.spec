...
Source0:	http://fossjon.fedorapeople.org/faii-%{version}.tar.gz
...
%changelog
* Thu Mar 08 2012 jchiappetta <jonc_mailbox@yahoo.ca> - 1.0.0-2
- usr share data dir change + desktop file + pipe object cleanup + windows drive
  letters

* Mon Feb 27 2012 jchiappetta <jonc_mailbox@yahoo.ca> - 1.0.0-1
- Initial packaging
